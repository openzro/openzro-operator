...
var _ = Describe("OZGroup Webhook", func() {
	var (
		obj       *openzrov1.OZGroup
		oldObj    *openzrov1.OZGroup
		validator OZGroupCustomValidator
	)
	...
	Context("When creating or updating OZGroup under Validating Webhook", func() {
		...
		When("OZResource owner exists", func() {
			BeforeEach(func() {
		...
		When("OZRoutingPeer owner exists", func() {
			BeforeEach(func() {
